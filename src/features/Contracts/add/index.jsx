...
import dataURItoBlob from 'src/utiltis/dataURItoBlob';
...
console.log("🚀 ~ Add ~ data:", data?.data?.data)
...
const { getRootProps, getInputProps } = useDropzone({
 ...
 const img = files.map(file => (
   <img key={file.name} alt={file.name} className='single-file-image' src={URL.createObjectURL(file)} style={{ width: '743px', height: '370px'}} />
 ))
