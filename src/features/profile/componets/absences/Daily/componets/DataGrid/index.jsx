...
import useAbsenceDailyColumns from '../../hooks/useAbsenceColumns'

const AbsenceDailyTable = ({ rows }) => {
  const columns = useAbsenceDailyColumns()
...
export default AbsenceDailyTable
