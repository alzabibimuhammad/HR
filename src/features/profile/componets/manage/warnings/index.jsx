...
import {   MenuItem, Divider,Accordion, AccordionSummary, AccordionDetails, IconButton, Avatar,  Modal } from '@mui/material';
...
import useGetWarnings from './hook/useGetWarnings';
...
<StackRow >
  <Box>
 <TypoHeader sx={{color:"#131627",fontWeight:"500"}}>{t('Warnings')} </TypoHeader>
  </Box>
  <Box>
...
<StackRow >
 ...
 <TypoHeader>{t('Total')}  {DataWarnings?.data?.data?.my_decisions?.length} {t('Warnings')} </TypoHeader>
  </Box>
