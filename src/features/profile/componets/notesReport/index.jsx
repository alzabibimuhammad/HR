    ...
    <Card>
      <CardContent>
        ...
        <Stack direction={'column'}  >
          <Typography color={'#3F4458'} fontSize={'14px'} >Note 1:</Typography>

          <Stack direction={'row'} width={'100%'} >
            <Box maxWidth={'100%'} >
              <Typography color={'#8090A7'} fontSize={'14px'} >Lorem ipsum, dolor sit amet consectetur adipisicing elit. Earum culpa a possimus eum beatae maiores impedit quasi exercitationem, pariatur quae placeat, eius at praesentium voluptates architecto ad laborum, rerum vitae?</Typography>
            </Box>

            <Stack direction={'row'} width={'50%'} spacing={1} justifyContent={'flex-end'} alignItems={'start'} >
              <EditIcon fontSize='20px' />
              <DeleteOutlineIcon fontSize='20px' />
            </Stack>
          </Stack>
          <Divider/>
        </Stack>
