...
import { useRejectSystem } from "../../Hooks/useRejectSystem";
import { useTranslation } from "react-i18next";

export default function AlertDialogDeleteSystem({ id, open, handleClose }) {
 const { mutate: RejectSystem, isLoading } = useRejectSystem();
  ...
  return (
    ...
    <Dialog
      ...
      <Typography  sx={{fontWeight:"600",fontSize:"16px",color:"#131627"}}>{t('Reject')}</Typography>
