...
export default function AlertDialogDeleteRieview({ id, open, handleClose }) {
    ...
    <Dialog
      ...
      <Grid item xs={12}>
        ...
        <DialogContentText sx={{}}>
          <CancelRoundedIcon  style={{ backgroundColor:"#FFFFFF",color: '#A20D29' ,fontSize: 160,position:"fixed",top: "45%", left: "50%", transform: "translate(-50%, -90%)",borderRadius:"50%" }} />
      ...
      <Typography  sx={{fontWeight:"600",fontSize:"16px",color:"#131627"}}>{t('Delete')} </Typography>
        ...
        {t("Are you sure you want to delete ")+" "+t("review")+"?"}
      </DialogTitle>
